...
export function SubmitBar({ selectedCount, totalCount, disabled, onSubmit, onReset }: SubmitBarProps) {
  return (
    <div className="inline-flex items-center gap-1.5 rounded-2xl border border-border/90 bg-card/80 p-1.5 shadow-md shadow-black/25">
      <p className={cn('px-2 text-[0.68rem] font-medium text-muted-foreground', selectedCount === totalCount && 'text-primary')}>
